...
if detector_data["PDGid_Det_Solenoid_1"] is not None:
    ...
    select_muons_pions_kaons_Det_Solenoid_1 = filter_by_pdgid(PDGid_Det_Solenoid_1, PDGID_muons_pions_kaons, "./Target_Rotate_theta_3_Beam_alpha_3_beta_0pt5_End_of_Solenoid_1.csv", True)
    ...
    r"PDG ID Distribution at the End of the Solenoid 1 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    ...
    r"PDG ID Distribution at the End of Solenoid 1 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    ...
    r"Energy Distribution of the Protons at the End of Solenoid 1 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    save_path="E_Protons_Det_Solenoid_1.png", bins=100
    )
    
    plot_1D_histogram(
    E_Muons_Det_Solenoid_1, "Energy (MeV)",
    r"Energy Distribution of the Muons at the End of Solenoid 1 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    save_path="E_Muons_Det_Solenoid_1.png", bins=100
    )

    plot_1D_histogram(
    E_Pions_Det_Solenoid_1, "Energy (MeV)",
    r"Energy Distribution of the Pions at the End of Solenoid 1 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    ...
    plot_scatter(x_Muons_Det_Solenoid_1, y_Muons_Det_Solenoid_1, "x (mm)", "y (mm)", r"Muon Distribution at the End of Solenoid 1 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",(-710, 710), (-710, 710), \
                s = 1, save_path = "Pos_Muons_Det_Solenoid_1.png")
    plot_scatter(x_Pions_Det_Solenoid_1, y_Pions_Det_Solenoid_1, "x (mm)", "y (mm)", r"Pions Distribution at the End of Solenoid 1 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",(-710, 710), (-710, 710), 
...
if detector_data["PDGid_Det_Solenoid_2"] is not None:
    ...
    select_muons_pions_kaons_Det_Solenoid_2 = filter_by_pdgid(PDGid_Det_Solenoid_2, PDGID_muons_pions_kaons, "./Target_Rotate_theta_3_Beam_alpha_3_beta_0pt5_End_of_Solenoid_2.csv", True)
    ...
    r"PDG ID Distribution at the End of the Solenoid 2 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    ...
    r"PDG ID Distribution at the End of Solenoid 2 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    ...
    r"Energy Distribution of the Protons at the End of Solenoid 2 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    save_path="E_Protons_Det_Solenoid_2.png", bins=100
    )
    
    plot_1D_histogram(
    E_Muons_Det_Solenoid_2, "Energy (MeV)",
    r"Energy Distribution of the Muons at the End of Solenoid 2 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    save_path="E_Muons_Det_Solenoid_2.png", bins=100
    )

    plot_1D_histogram(
    E_Pions_Det_Solenoid_2, "Energy (MeV)",
    r"Energy Distribution of the Pions at the End of Solenoid 2 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    ...
    # Plot 2D scatter (x vs y) for filtered muons
    plot_scatter(x_Muons_Det_Solenoid_2, y_Muons_Det_Solenoid_2, "x (mm)", "y (mm)", r"Muon Distribution at the End of Solenoid 2 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",(-710, 710), (-710, 710), \
                s = 1, save_path = "Pos_Muons_Det_Solenoid_2.png")
    plot_scatter(x_Pions_Det_Solenoid_2, y_Pions_Det_Solenoid_2, "x (mm)", "y (mm)", r"Pions Distribution at the End of Solenoid 2 (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",(-710, 710), (-710, 710), 
...
if detector_data["PDGid_Det__2000mm_Solenoid"] is not None:
    ...
    select_muons_pions_kaons_Det_minus2000mm_Solenoid = filter_by_pdgid(PDGid_Det_minus2000mm_Solenoid, PDGID_muons_pions_kaons, "./Target_Rotate_theta_3_Beam_alpha_3_beta_0pt5_End_of_Solenoid_Back.csv", True)
    ...
    r"PDG ID Distribution at the End of the Solenoid Back (KE= 8 GeV, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    discrete=True, save_path="PDGID_muons_pions_kaons_Det__2000mm_Solenoid.png"
    ) 

    plot_1D_histogram(
    detector_data['PDGid_Det__2000mm_Solenoid'][select_muons_pions_kaons_Det_minus2000mm_Solenoid], "PDG ID",
    r"PDG ID Distribution at the End of Solenoid Back (KE= 8 GeV, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    ...
    r"Energy Distribution of the Protons at the End of Solenoid Back (KE= 8 GeV, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    save_path="E_Protons_Det__2000mm_Solenoid.png", bins=100
    )
    
    plot_1D_histogram(
    E_Muons_Det_minus2000mm_Solenoid, "Energy (MeV)",
    r"Energy Distribution of the Muons at the End of Solenoid Back (KE= 8 GeV, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    save_path="E_Muons_Det__2000mm_Solenoid.png", bins=100
    )

    plot_1D_histogram(
    E_Pions_Det_minus2000mm_Solenoid, "Energy (MeV)",
    r"Energy Distribution of the Pions at the End of Solenoid Back (KE= 8 GeV, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    ...
    # Plot 2D scatter (x vs y) for filtered muons
    plot_scatter(x_Muons_Det_minus2000mm_Solenoid, y_Muons_Det_minus2000mm_Solenoid, "x (mm)", "y (mm)", r"Muon Distribution at the End of Solenoid Back (KE= 8 GeV, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",(-710, 710), (-710, 710), \
                s = 1, save_path = "Pos_Muons_Det__2000mm_Solenoid.png")
    plot_scatter(x_Pions_Det_minus2000mm_Solenoid, y_Pions_Det_minus2000mm_Solenoid, "x (mm)", "y (mm)", r"Pions Distribution at the End of Solenoid Back (KE= 8 GeV, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",(-710, 710), (-710, 710), 
...
if detector_data["PDGid_Det_Target_Side"] is not None:
    ...
    select_muons_pions_kaons_Det_Target_Side = filter_by_pdgid(PDGid_Det_Target_Side, PDGID_muons_pions_kaons, "./Target_Rotate_theta_3_Beam_alpha_3_beta_0pt5_Target_Side.csv", True)
    ...
    for offset in initz_offsets:
        ...
        plot_scatter(
            x_mu, y_mu, "x (mm)", "y (mm)",
            fr"Muon Distribution (InitZ = {offset} mm) at Target Side (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)", (-35, 35), (-35, 35), s=1, save_path=pos_muon_plot_path
        )
    
        plot_scatter(
            x_pi, y_pi, "x (mm)", "y (mm)",
            fr"Pion Distribution (InitZ = {offset} mm) at Target Side (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)", (-35, 35), (-35, 35), s=1, save_path=pos_pion_plot_path
        )
        ...
        plot_scatter(
            ...
            fr"Muon Phase Space: x vs p_x (InitZ = {offset} mm, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
            s=1, save_path=f"PhaseSpace_x_px_Initz_{offset}_Muons.png"
        )
        
        plot_scatter(
            y_mu, py_mu, "y (mm)", r"p_y (MeV)",
            fr"Muon Phase Space: y vs p_y (InitZ = {offset} mm, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
            s=1, save_path=f"PhaseSpace_y_py_Initz_{offset}_Muons.png"
        )
        
        plot_scatter(
            z_mu, pz_mu, "z (mm)", r"p_z (MeV)",
            fr"Muon Phase Space: z vs p_z (InitZ = {offset} mm, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
        ...
        plot_scatter(
            ...
            fr"Pion Phase Space: x vs p_x (InitZ = {offset} mm, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
            s=1, save_path=f"PhaseSpace_x_px_Initz_{offset}_Pions.png"
        )
        
        plot_scatter(
            y_pi, py_pi, "y (mm)", r"p_y (MeV)",
            fr"Pion Phase Space: y vs p_y (InitZ = {offset} mm, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
            s=1, save_path=f"PhaseSpace_y_py_Initz_{offset}_Pions.png"
        )
        
        plot_scatter(
            z_pi, pz_pi, "z (mm)", r"p_z (MeV)",
            fr"Pion Phase Space: z vs p_z (InitZ = {offset} mm, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    ...
    plt.xlabel("x (mm)")
    plt.ylabel("y (mm)")
    plt.title(r"Muon XY Distribution at Target Side (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
    plt.xlim(-35, 35)
    plt.ylim(-35, 35)
    ...
    plt.xlabel("x (mm)")
    plt.ylabel("y (mm)")
    plt.title(r"Pion XY Distribution at Target Side (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
    plt.xlim(-35, 35)
    plt.ylim(-35, 35)
    plt.legend(markerscale=4, fontsize="small", loc="upper right")
    plt.grid(True)
    ...
    r"PDG ID Distribution at the Side of the Target (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    ...
    r"Energy Distribution of the Protons at the Side of the Target (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    save_path="E_Protons_Det_Target_Side.png", bins=100
    )
    
    plot_1D_histogram(
    E_Muons_Det_Target_Side, "Energy (MeV)",
    r"Energy Distribution of the Muons at the Side of the Target (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    save_path="E_Muons_Det_Target_Side.png", bins=100
    )

    plot_1D_histogram(
    E_Pions_Det_Target_Side, "Energy (MeV)",
    r"Energy Distribution of the Pions at the Side of the Target (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    ...
    plot_scatter(x_Muons_Det_Target_Side, y_Muons_Det_Target_Side, "x (mm)", "y (mm)", r"Muon Distribution at the Side of the Target (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",(-35, 35), (-35, 35), \
                s = 1, save_path = "Pos_Muons_Det_Target_Side.png")
    plot_scatter(x_Pions_Det_Target_Side, y_Pions_Det_Target_Side, "x (mm)", "y (mm)", r"Pions Distribution at the Side of the Target (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",(-35, 35), (-35, 35), 
...
if detector_data["PDGid_Det_Target_Side"] is not None:
    ...
    for i, offset in enumerate(initz_offsets):
        ...
        ax.set_title(fr"Muons {label} x vs y (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
        ax.set_xlabel("x (mm)")
        ax.set_ylabel("y (mm)")
        ...
        ax.set_title(fr"Pions {label} x vs y ( r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
        ax.set_xlabel("x (mm)")
        ax.set_ylabel("y (mm)")
        ax.figure.tight_layout()
    ...
    for var in ["x", "y"]:
        plot_grouped_1d(hist1d_mu_x_y, var,
                        xlabel=f"{var} [mm]",
                        title=fr"Muon {var} Distribution by InitZ (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
    ...
    for var in ["x", "y"]:
        plot_grouped_1d(hist1d_pi_x_y, var,
                        xlabel=f"{var} [mm]",
                        title=fr"Pion {var} Distribution by InitZ (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
...
plt.title(fr"Proton Counts per Sample Detector (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
plt.tight_layout()
...
plt.xlabel("z (mm)")
plt.ylabel("x (mm)")
plt.title(fr"Proton Beam: x vs z (TrackID = 1) (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
plt.grid(True)
plt.tight_layout()
...
plt.xlabel("z (mm)")
plt.ylabel("y (mm)")
plt.title(fr"Proton Beam: y vs z (TrackID = 1) (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
plt.grid(True)
plt.tight_layout()
...
plt.xlabel("x (mm)")
plt.ylabel("y (mm)")
plt.title(fr"Proton Beam: x vs y (TrackID = 1) (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
plt.grid(True)
plt.tight_layout()
...
plot_hist2d_tagged(hist2d_xz_yz, "xz", "y", "z (mm)", "x (mm)", fr"Proton Beam: x vs z (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)", "Proton_x_vs_z_hist2d_tagged.png")
plot_hist2d_tagged(hist2d_xz_yz, "yz", "y", "z (mm)", "y (mm)", fr"Proton Beam: y vs z (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)", "Proton_y_vs_z_hist2d_tagged.png")
plot_hist2d_tagged(hist2d_xy, "xy", "x", "x (mm)", "y (mm)", fr"Proton Beam: x vs y (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)", "Proton_x_vs_y_hist2d_tagged.png")
...
ax.set_title(fr"Protons zNtuple x vs z (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.set_xlabel("z (mm)")
ax.set_ylabel("x (mm)")
ax.figure.tight_layout()
...
ax.set_title(fr"Protons zNtuple y vs z (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.set_xlabel("z (mm)")
ax.set_ylabel("y (mm)")
ax.figure.tight_layout()
...
ax.set_title(fr"Protons zNtuple x vs y (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.set_xlabel("x (mm)")
ax.set_ylabel("y (mm)")
ax.figure.tight_layout()
...
ax.set_title(fr"PiPlus zNtuple InitX vs InitZ (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.set_xlabel("z (mm)")
ax.set_ylabel("x (mm)")
ax.figure.tight_layout()
...
ax.set_title(fr"PiPlus zNtuple InitY vs InitZ (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.set_xlabel("z (mm)")
ax.set_ylabel("y (mm)")
ax.figure.tight_layout()
...
ax.set_title(fr"PiPlus zNtuple InitX vs InitY (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.set_xlabel("x (mm)")
ax.set_ylabel("y (mm)")
ax.figure.tight_layout()
...
ax.set_title(fr"PiMinus zNtuple InitX vs InitZ (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.set_xlabel("z (mm)")
ax.set_ylabel("x (mm)")
ax.figure.tight_layout()
...
ax.set_title(fr"PiMinus zNtuple InitY vs InitZ (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.set_xlabel("z (mm)")
ax.set_ylabel("y (mm)")
ax.figure.tight_layout()
...
ax.set_title(fr"PiMinus zNtuple InitX vs InitY (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.set_xlabel("x (mm)")
ax.set_ylabel("y (mm)")
ax.figure.tight_layout()
...
for var in ["InitX", "InitY"]:
    plot_pions_Init_1d( hist1d_pi_x_y, var,
                        xlabel=f"{var} [mm]",
                        title=fr"Pions {var} Distribution Inside Target (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)",
...
ax.set_ylabel("Entries")
ax.set_title(fr"Comparison of Pions Px Distribution (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.grid(True)
...
ax.set_title(fr"Efficiency of Pions Px Distribution (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.grid(True)
plt.tight_layout()
...
ax.set_ylabel("Entries")
ax.set_title(fr"Comparison of Pions Py Distribution (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.grid(True)
ax.legend(title=f"Detectors")
plt.tight_layout()
...
# ax.set_xlabel("Py (MeV)")
# ax.set_ylabel("Efficiency")
# ax.set_title(fr"Efficiency of Pions Py Distribution (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
# ax.grid(True)
# plt.tight_layout()
...
ax.set_ylabel("Entries")
ax.set_title(fr"Comparison of Pions Pz Distribution (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.grid(True)
ax.legend(title=f"Detectors")
plt.tight_layout()
...
# ax.set_ylabel("Efficiency")
# ax.set_xlim(left=0)
# ax.set_title(fr"Efficiency of Pions Pz Distribution (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
# ax.grid(True)
# plt.tight_layout()
...
ax.set_ylabel("Entries")
ax.set_title(fr"Comparison of Pions KE Distribution (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
ax.grid(True)
ax.legend(title=f"Detectors")
plt.tight_layout()
...
# ax.set_ylabel("Efficiency")
# ax.set_xlim(left=0)
# ax.set_title(fr"Efficiency of Pions KE Distribution (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
# ax.grid(True)
# plt.tight_layout()
...
for var, h in histograms_momentum.items():
    ...
    ax.set_ylabel("Entries")
    ax.set_title(fr"Stacked Distribution of {var} for Pions Inside Target (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
    ax.grid(True)
...
for var, h in histograms_combined_label_momentum.items():
    ...
    ax.set_xlabel(f"{var} (MeV)")
    ax.set_ylabel("Entries")
    ax.set_title(fr"Stacked distribution of {var} by interaction and Charge Inside Target (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
    ax.grid(True)
...
for var, h in histograms_momentum.items():
    ...
    ax.set_xlabel(f"{var} (MeV)")
    ax.set_ylabel("Entries")
    ax.set_title(fr"Stacked Distribution of {var} for Pions Around Target (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
    ax.grid(True)
    ax.legend(title="Interaction Type", labels=labels)
    plt.tight_layout()
...
for var, h in histograms_combined_label_momentum.items():
    ...
    ax.set_xlabel(f"{var} (MeV)")
    ax.set_ylabel("Entries")
    ax.set_title(fr"Stacked distribution of {var} by interaction and Charge Around Target (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
    ax.grid(True)
    ax.legend(title="Interaction + Particle", labels=labels)
    plt.tight_layout()
...
for var in ["x", "y", "z"]:
    ...
    ax.set_ylabel("Entries")
    ax.set_title(fr"{var} Position by Category and Region (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
    ax.grid(True)
...
for var in ["z"]:
    ...
    for color_target, lbl in zip(line_colors_target, labels):
        ...
        ax.set_xlabel(f"{var} (mm)")
        ax.set_ylabel("Entries")
        ax.set_title(fr"{var} Position of {lbl.name} (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
        ax.grid(True)
...
for var in ["P"]:
    ...
    for color_target, color_det, lbl in zip(line_colors_target, line_colors_Det, labels):
        ...
        ax.set_xlabel(f"{var} (MeV)")
        ax.set_ylabel("Entries")
        ax.set_title(fr"{var} of {lbl.name} (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
        ax.grid(True)
        ax.legend(legend_labels, fontsize=9, loc="best", title="Interaction + Region")
        plt.tight_layout()
        if '$\pi^-$' in lbl.name:
...
for phase_var, axes in [("x_px", ("x", "px")), ("y_py", ("y", "py"))]:
    ...
    for lbl in labels:
        ...
        if h_det_solenoid_1.values().get(()) is not None:
            ...
            ax.set_title(fr"{phase_var.replace('_', ' vs ')}: {lbl} (Det_Solenoid_1, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
        ...
        if h_det_solenoid_2.values().get(()) is not None:
            ...
            ax.set_title(fr"{phase_var.replace('_', ' vs ')}: {lbl} (Det_Solenoid_2, r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
            ax.set_xlabel(f"{axes[0]} (mm)")
            ax.set_ylabel(f"{axes[1]} (MeV)")
            ax.grid(False)
            plt.tight_layout()
...
for lbl in hist_2d_KE_EffKE.axis("label").identifiers():
    ...
    ax.set_title(fr"Energy Loss Distribution by Initial KE: {lbl} (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
    plt.tight_layout()
...
for lbl in hist_2d_z_EffKE.axis("label").identifiers():
    ...
    ax.set_title(fr"Energy Loss Distribution by Initial z position: {lbl} (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
    plt.tight_layout()
    # Start from the label name
    label_str = lbl.name
...
for lbl in hist_2d_z_KE.axis("label").identifiers():
    ...
    ax.set_title(fr"Matched Pions KE Distribution: {lbl} (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
    plt.tight_layout()
    # Start from the label name
    label_str = lbl.name
...
for lbl in hist_2d_z_z.axis("label").identifiers():
    ...
    ax.set_title(fr"Initial z position vs Around z position: {lbl} (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
    plt.tight_layout()
    # Start from the label name
    label_str = lbl.name
...
for var, h in histograms_unmatched_inside.items():
    ...
    for color, lbl in zip(line_colors, labels):
        ...
        ax.set_ylabel("Entries")
        ax.set_title(fr"Unmatched Pions {var} Distribution: {lbl} (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
        ax.grid(True)
        plt.tight_layout()
...
for lbl in hist2d_z_KE_unmatched.axis("label").identifiers():
    ...
    ax.set_title(fr"Unmatched Pions: z vs KE Distribution {lbl} (r = 30mm, $\theta = 3, \alpha = 3, \beta = 0.5$)")
    ax.grid(True)
    plt.tight_layout()
